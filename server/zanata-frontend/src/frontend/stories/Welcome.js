      ...
      <div style={styles.main}>
        ...
        <p>
          See these sample <a style={styles.link} href='#'
            onClick={::this.showApp}>stories</a> for a component called
        ...
        <p>
          ...
          Have a look at the <a style={styles.link}
            href='https://github.com/kadirahq/react-storybook' target='_blank'>
          React Storybook</a> repo for more information.
        </p>
        <p style={styles.note}>
          <b>NOTE:</b>
          <br />
          Have a look at the <code style={styles.code}>
          .storybook/webpack.config.js</code> to add webpack
